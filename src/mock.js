...
export const mockUsers = [
  ...
  },
  {
    ...
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sophia&hair=long02&hairColor=auburn&eyes=happy&mouth=smile&skinColor=light',
...
export const mockTweets = [
  ...
  },
  {
    id: '2',
    userId: '2',
    content: 'Made friendship bracelets today! 💕 Who wants one? Comment your favorite colors below! 👇',
    image: 'https://images.unsplash.com/photo-1611652022419-a9419f74343a?w=600&h=400&fit=crop',
    likes: 567,
    retweets: 89,
    comments: 43,
  ...
  },
  {
    id: '3',
    userId: '3',
    content: 'Just learned how to code a game in Scratch! 🎮 It\'s about a unicorn collecting stars! ⭐ So fun!',
    likes: 834,
    retweets: 156,
    comments: 67,
  ...
  },
  {
    id: '4',
    userId: '4',
    content: 'Baked rainbow cupcakes with my family today! 🧁 They taste as good as they look! 🌈',
  ...
  },
  {
    id: '5',
    userId: '1',
    content: 'Found the coolest cloud shaped like a heart today! ☁️💕 Nature is amazing!',
  ...
  },
  {
    id: '6',
    userId: '3',
    content: 'Reading the best book ever! 📚 It\'s about magical creatures and friendship! Highly recommend! ✨',
